...
class ProductAdmin(admin.ModelAdmin):
    list_display = [
        'id', 'sku', 'barcode', 'nama_produk', 'variant_produk', 'brand', 'rak', 'photo'
    ]
    ...
    def export_csv(self, request):
        ...
        writer.writerow(['id', 'sku', 'barcode', 'nama_produk', 'variant_produk', 'brand', 'rak'])
        for p in Product.objects.all():
            writer.writerow([p.id, p.sku, p.barcode, p.nama_produk, p.variant_produk, p.brand, p.rak])
        return response
